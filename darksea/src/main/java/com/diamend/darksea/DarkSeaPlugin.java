...
import com.diamend.darksea.loot.LootTable;
...
public final class DarkSeaPlugin extends JavaPlugin {
    ...
    private volatile Map<Integer, LootTable> lootTables;
    ...
    private Map<Integer, LootTable> loadLootTables() {
    ...
    public Map<Integer, LootTable> lootTables() {
        return lootTables;
    }
