...
> This is a separate project from *CustomAchievements*, *AntiCheat*, *RoboBear*
> and *Spyglass* in the same repository: different module (`boxcore/`),
> different package (`com.diamend.boxcore`), different purpose.
