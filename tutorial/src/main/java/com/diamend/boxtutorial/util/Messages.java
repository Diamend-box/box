 ...
 * before the string is parsed, so a value that itself contains colour codes (a
 * step's display name, say) renders properly.
 */
public class Messages {
    ...
    /** {@code ""} for 1, {@code "s"} otherwise — for "<amount> step<plural>". */
